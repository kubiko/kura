...
# cp ${SNAP}/kura/install/ifup-local.snap ${SNAP_COMMON}/etc/network/if-up.d/ifup-local
# cp ${SNAP}/kura/install/ifdown-local ${SNAP_COMMON}/etc/network/if-down.d/ifdown-local
...
# TO-DO: firewall init is now in SNAP and exposed over layouts, is there need to edit it?
# populate_overlayed_file "${SNAP}/kura/install/firewall.init" "${SNAP_COMMON}/etc/init.d/firewall"
# populate_overlayed_file "etc/init.d/firewall"

# populate_overlayed_file "${SNAP}/kura/install/iptables.init" "${SNAP_COMMON}/etc/sysconfig/iptables"
populate_overlayed_file "${SNAP}/etc/sysconfig/iptables" "${SNAP_COMMON}/etc/sysconfig/iptables"
# cp ${SNAP}/kura/install/iptables.init ${SNAP_COMMON}/.data/iptables
