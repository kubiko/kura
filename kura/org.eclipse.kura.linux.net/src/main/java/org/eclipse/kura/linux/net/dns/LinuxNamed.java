...
public class LinuxNamed {
    ...
    public boolean enable() throws KuraException {
        ...
        try {
            ...
            if (OS_VERSION.equals(
            ...
            } else if (OS_VERSION.equals(KuraConstants.ReliaGATE_10_05.getImageName() + "_"
                ...
                result = LinuxProcessUtil.start("/etc/init.d/bind9 start");
                    ...
                    KuraConstants.Intel_Edison.getImageName() + "_" + KuraConstants.Intel_Edison.getImageVersion() + "_"
    ...
    public boolean isConfigured() {
        if (this.m_dnsServerConfigIP4 != null && this.m_dnsServerConfigIP4.getForwarders() != null
                && this.m_dnsServerConfigIP4.getForwarders().size() > 0
                && this.m_dnsServerConfigIP4.getAllowedNetworks() != null
                && this.m_dnsServerConfigIP4.getAllowedNetworks().size() > 0) {
            return true;
        } else {
            return false;
        }
    ...
    private void writeConfig() throws KuraException {
        try {
            ...
            if (this.m_dnsServerConfigIP4 == null || this.m_dnsServerConfigIP4.getForwarders() == null
                    ...
                    || this.m_dnsServerConfigIP4.getForwarders().size() == 0
                    || this.m_dnsServerConfigIP4.getAllowedNetworks().size() == 0) {
                s_logger.debug("writing default named.conf to {} with: {}", s_persistentConfigFileName,
                        this.m_dnsServerConfigIP4.toString());
                pw.print(getDefaultNamedFile());
            } else {
                s_logger.debug("writing custom named.conf to {} with: {}", s_persistentConfigFileName,
                        this.m_dnsServerConfigIP4.toString());
